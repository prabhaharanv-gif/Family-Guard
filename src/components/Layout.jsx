...
const NAV_ITEMS = [
  {
    ...
    icon: (active) => (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <circle cx="9" cy="7" r="3" fill={active ? '#951345' : '#8F8076'}/>
        <path d="M3 20C3 16.134 5.686 13 9 13C12.314 13 15 16.134 15 20H3Z" fill={active ? '#951345' : '#8F8076'}/>
        <circle cx="17.5" cy="8.5" r="2.2" fill={active ? '#C0185A' : '#C3B7A8'}/>
        <path d="M13.5 20C13.5 17.239 15.239 15 17.5 15C19.761 15 21.5 17.239 21.5 20H13.5Z" fill={active ? '#C0185A' : '#C3B7A8'}/>
      </svg>
    ),
  },
  {
    ...
    icon: (active) => (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M21 15C21 15.5304 20.7893 16.0391 20.4142 16.4142C20.0391 16.7893 19.5304 17 19 17H7L3 21V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H19C19.5304 3 20.0391 3.21071 20.4142 3.58579C20.7893 3.96086 21 4.46957 21 5V15Z"
          fill={active ? '#951345' : '#8F8076'} stroke="none"/>
  ...
  },
  {
    ...
    icon: (active) => (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <circle cx="12" cy="11" r="1" fill={active ? '#951345' : '#8F8076'}/>
      </svg>
    ),
  },
  {
    ...
    icon: (active) => (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <circle cx="12" cy="8" r="3.8" fill={active ? '#951345' : '#8F8076'}/>
        <path d="M4 20C4 16.134 7.582 13 12 13C16.418 13 20 16.134 20 20"
          stroke={active ? '#951345' : '#8F8076'} strokeWidth="2.5" strokeLinecap="round"/>
      </svg>
    ),
  },
]
