 ...
 *
 * ── 26 September 2026, part two: a full table-by-table pass ────────────────
 * Asked "did you check everything," a second pass went through every table
 * in the migrations, not just the features noticed in passing, and found one
 * outright error and three more undisclosed things:
 *
 *   - WRONG: "Your nicknames for other members... are stored on your phone
 *     for you alone" and the retention line listing nicknames among what "go
 *     when you uninstall the app". Neither is true — member_nicknames is a
 *     server-side table (useNicknames.js reads it over PostgREST), private to
 *     the owner by RLS, and cleared by leave_family / remove_member_cleans_up
 *     when either side leaves the group, or by delete_my_account — not by an
 *     uninstall. Corrected in onphone, retention, and given its own Collect/
 *     Use lines instead of living in "what stays on your phone", where it
 *     never belonged.
 *   - Read receipts (message_reads, and direct_messages.read_at behind the
 *     single/double tick) were never mentioned — that a message shows as read,
 *     and when. retention_job_3 clears message_reads once its message is
 *     gone, so the retention line says the same.
 *   - Emoji reactions (message_reactions, 2026-08-31) were undisclosed. Also
 *     folded into the attachment-retention line: the 90-day cron
 *     (retention_job_1) deletes the message row directly, not through
 *     delete_message/delete_direct_message, so reactions on a cron-purged
 *     message are left behind exactly as attachments are.
 *   - Single-active-device enforcement (user_active_device, 2026-08-31) signs
 *     out every other device when one signs in, and was undocumented. What it
 *     stores is a random per-install id and a generic label ("Android app"),
 *     never a hardware identifier — added to Protect, where the other
 *     account-security measures already live.
 *
 * Checked and deliberately left undisclosed, because they add no category of
 * data beyond what is already on this page: audit_log (an internal record of
 * SOS creation and member removal — both already disclosed elsewhere; its
 * ip_address column exists but nothing ever writes to it), user_consents
 * (records that you accepted this policy and when — the acceptance ConsentGate
 * itself performs, not a new kind of data about you), and user_profiles (a
 * second home for the same avatar/phone already disclosed, needed only so a
 * photo survives a user who has not yet joined a family — see that
 * migration's own comment). geofences was dropped entirely by the per-member-
 * places migration and no longer exists.
 *
    ...
    sections: {
      collect: {
        ...
        items: [
          ...
          "A private nickname you set for another member — visible only to you, never to them or anyone else — stored on our servers rather than your phone",
          "That you have read a message, and when — shown to others as a tick or a 'seen' time",
          "Any emoji reaction you add to a message",
      ...
      use: {
        ...
        items: [
          ...
          "A nickname you set for someone is private to you alone; not even the person it is about can see it",
          "A read receipt or an emoji reaction is visible to whoever can already see the message it is on",
      ...
      onphone: {
        ...
        items: [
          ...
          'Your language choice is stored on your phone for you alone',
      ...
      protect: {
        ...
        items: [
          ...
          'A random, per-install device id (never a hardware identifier) and a generic label such as "Android app" keep your account signed in on only one device at a time; signing in elsewhere signs the older device out automatically',
        ],
      },
      retention: {
        ...
        items: [
          ...
          'A photo, video, voice note, document or emoji reaction attached to a message is not automatically removed when that 90-day purge runs',
          'A read receipt (that you have read a message, and when) is removed together with the message it belongs to',
          'A nickname you set for someone is removed when either of you leaves that family group, or when you delete your account',
          ...
          'Settings kept on your phone — fake call details, offline SMS numbers — go when you uninstall the app',
...
'பேட்டரி அளவு, சார்ஜ் நிலை, மற்றும் நகரும்போது வேகம் — உங்கள் இருப்பிடத்துடன் சேர்த்து குடும்பத்திற்குக் காட்டப்படும்',
          ...
          "மற்றொரு உறுப்பினருக்காக நீங்கள் வைக்கும் தனிப்பட்ட செல்லப்பெயர் — உங்களுக்கு மட்டுமே தெரியும், அவர்களுக்கோ வேறு யாருக்கோ இல்லை — உங்கள் ஃபோனில் அல்ல, எங்கள் சர்வர்களில் சேமிக்கப்படுகிறது",
          "நீங்கள் ஒரு செய்தியைப் படித்தீர்கள் என்பதும் எப்போது படித்தீர்கள் என்பதும் — மற்றவர்களுக்கு ஒரு டிக் அல்லது 'பார்க்கப்பட்டது' நேரமாகக் காட்டப்படும்",
          "ஒரு செய்திக்கு நீங்கள் சேர்க்கும் ஏதேனும் emoji எதிர்வினை",
...
'இயக்க உணரி அளவீடுகள், "குலுக்கினால் SOS" இயக்கத்தில் இருக்கும்போது மட்டும் — அவை உங்கள் கைபேசியிலேயே ஆராயப்படுகின்றன, எங்கும் அனுப்பப்படுவதில்லை',
      ...
      use: {
        ...
        items: [
          ...
          "மற்றொருவருக்காக நீங்கள் வைக்கும் செல்லப்பெயர் உங்களுக்கு மட்டுமே தெரியும்; அது யாரைப் பற்றியதோ அவர்களுக்குக் கூட தெரியாது",
          "ஒரு படித்த-ரசீது அல்லது emoji எதிர்வினை, அந்தச் செய்தியை ஏற்கனவே பார்க்க முடிந்தவர்களுக்குத் தெரியும்",
      ...
      onphone: {
        ...
        items: [
          ...
          'உங்கள் மொழித் தேர்வு உங்களுக்காக மட்டும் கைபேசியில் சேமிக்கப்படுகிறது',
      ...
      protect: {
        ...
        items: [
          ...
          "ஒரு தற்செயலான, நிறுவல்-வாரியான சாதன அடையாளமும் (இது ஒருபோதும் வன்பொருள் அடையாளம் அல்ல) \"Android app\" போன்ற பொதுவான குறிச்சொல்லும் உங்கள் கணக்கை ஒரு நேரத்தில் ஒரு சாதனத்தில் மட்டும் உள்நுழைந்திருக்கச் செய்யப் பயன்படுகிறது; வேறு இடத்தில் உள்நுழைந்தால் பழைய சாதனம் தானாக வெளியேற்றப்படும்",
        ],
      },
      retention: {
        ...
        items: [
          ...
          'ஒரு செய்திக்கு இணைக்கப்படும் புகைப்படம், வீடியோ, குரல் குறிப்பு, ஆவணம் அல்லது emoji எதிர்வினை அந்த 90-நாள் அகற்றல் நடக்கும்போது தானாக நீக்கப்படாது',
          "ஒரு படித்த-ரசீது அந்தச் செய்தியுடன் சேர்ந்தே நீக்கப்படும்",
          "நீங்கள் ஒருவருக்காக வைத்த செல்லப்பெயர், அவர் அல்லது நீங்கள் அந்தக் குடும்பக் குழுவை விட்டு வெளியேறும்போது, அல்லது நீங்கள் கணக்கை நீக்கும்போது நீக்கப்படும்",
...
'உங்கள் கைபேசியில் சேமிக்கப்படும் அமைப்புகள் — போலி அழைப்பு விவரங்கள், "இணையம் இல்லாதபோது SMS" எண்கள் — செயலியை நீக்கும்போது போய்விடும்',
...
'बैटरी स्तर, चार्जिंग की स्थिति और चलते समय गति — आपकी लोकेशन के साथ परिवार को दिखते हैं',
          ...
          "किसी दूसरे सदस्य के लिए आपका रखा निजी उपनाम — सिर्फ़ आपको दिखता है, उन्हें या किसी और को नहीं — आपके फ़ोन पर नहीं, हमारे सर्वर पर रखा जाता है",
          "आपने कोई संदेश पढ़ लिया है और कब पढ़ा — दूसरों को टिक या 'सीन' समय के रूप में दिखता है",
          "आप किसी संदेश पर जो इमोजी रिएक्शन जोड़ते हैं",
...
'मोशन सेंसर की रीडिंग, केवल तब जब "हिलाकर SOS" चालू हो — इन्हें आपके फ़ोन पर ही परखा जाता है, कहीं भेजा नहीं जाता',
      ...
      use: {
        ...
        items: [
          ...
          "किसी के लिए आपका रखा उपनाम सिर्फ़ आपके लिए निजी है; जिसके बारे में है वह भी उसे नहीं देख सकता",
          "रीड रिसीट या इमोजी रिएक्शन उसी को दिखता है जो संदेश को पहले से देख सकता है",
      ...
      onphone: {
        ...
        items: [
          ...
          'आपकी भाषा का चुनाव सिर्फ़ आपके लिए फ़ोन पर रखा जाता है',
      ...
      protect: {
        ...
        items: [
          ...
          "एक रैंडम, इंस्टॉल-विशिष्ट डिवाइस आइडी (कभी हार्डवेयर पहचान नहीं) और \"Android app\" जैसा एक सामान्य लेबल आपके खाते को एक समय पर सिर्फ़ एक डिवाइस पर साइन इन रखने के लिए इस्तेमाल होते हैं; कहीं और साइन इन करने पर पुराना डिवाइस अपने आप साइन आउट हो जाता है",
        ],
      },
      retention: {
        ...
        items: [
          ...
          'किसी संदेश से जुड़ा फ़ोटो, वीडियो, वॉइस नोट, दस्तावेज़ या इमोजी रिएक्शन उस 90-दिन की सफ़ाई के दौरान अपने आप नहीं हटता',
          "रीड रिसीट उस संदेश के साथ ही हट जाती है",
          "किसी के लिए रखा उपनाम तब हटता है जब आप में से कोई भी उस परिवार समूह को छोड़ता है, या आप खाता हटाते हैं",
...
'आपके फ़ोन पर रखी सेटिंग्स — नकली कॉल का विवरण, "इंटरनेट न होने पर SMS" के नंबर — ऐप अनइंस्टॉल करने पर चली जाती हैं',
...
'బ్యాటరీ స్థాయి, ఛార్జింగ్ స్థితి, కదులుతున్నప్పుడు వేగం — మీ లొకేషన్‌తో పాటు కుటుంబానికి కనిపిస్తాయి',
          ...
          "మరో సభ్యుడి కోసం మీరు పెట్టే ప్రైవేట్ ముద్దుపేరు — మీకు మాత్రమే కనిపిస్తుంది, వారికి కానీ మరెవరికి కానీ కాదు — మీ ఫోన్‌లో కాకుండా మా సర్వర్‌లలో నిల్వ చేయబడుతుంది",
          "మీరు ఒక సందేశాన్ని చదివారు అనే విషయం, ఎప్పుడు చదివారు — ఇతరులకు టిక్ లేదా 'సీన్' సమయంగా చూపబడుతుంది",
          "మీరు ఒక సందేశానికి జోడించే ఏదైనా ఎమోజీ రియాక్షన్",
...
'మోషన్ సెన్సార్ రీడింగ్‌లు, "ఊపితే SOS" ఆన్‌లో ఉన్నప్పుడు మాత్రమే — అవి మీ ఫోన్‌లోనే పరిశీలించబడతాయి, ఎక్కడికీ పంపబడవు',
      ...
      use: {
        ...
        items: [
          ...
          "మీరు ఎవరి కోసమైనా పెట్టే ముద్దుపేరు మీకు మాత్రమే ప్రైవేట్‌గా ఉంటుంది; అది ఎవరి గురించో వారికి కూడా కనిపించదు",
          "రీడ్ రిసీట్ లేదా ఎమోజీ రియాక్షన్ ఆ సందేశాన్ని ఇప్పటికే చూడగలిగే వారికి మాత్రమే కనిపిస్తుంది",
      ...
      onphone: {
        ...
        items: [
          ...
          'మీ భాష ఎంపిక మీ కోసం మాత్రమే ఫోన్‌లో ఉంచబడుతుంది',
      ...
      protect: {
        ...
        items: [
          ...
          "ఒక రాండమ్, ఇన్‌స్టాల్-వారీ డివైస్ ఐడీ (ఎప్పుడూ హార్డ్‌వేర్ ఐడెంటిఫయర్ కాదు) మరియు \"Android app\" వంటి సాధారణ లేబుల్ మీ ఖాతాను ఒకేసారి ఒక్క డివైస్‌లో మాత్రమే సైన్ ఇన్‌గా ఉంచడానికి ఉపయోగిస్తారు; వేరే చోట సైన్ ఇన్ చేస్తే పాత డివైస్ స్వయంచాలకంగా సైన్ అవుట్ అవుతుంది",
        ],
      },
      retention: {
        ...
        items: [
          ...
          'ఒక సందేశానికి జోడించిన ఫోటో, వీడియో, వాయిస్ నోట్, డాక్యుమెంట్ లేదా ఎమోజీ రియాక్షన్ ఆ 90-రోజుల తొలగింపు జరిగినప్పుడు స్వయంచాలకంగా తీసివేయబడదు',
          "రీడ్ రిసీట్ ఆ సందేశంతో పాటే తొలగించబడుతుంది",
          "మీరు ఎవరికైనా పెట్టిన ముద్దుపేరు, మీలో ఎవరైనా ఆ కుటుంబ గ్రూప్‌ను వదిలేసినప్పుడు లేదా మీరు ఖాతాను తొలగించినప్పుడు తొలగించబడుతుంది",
...
'మీ ఫోన్‌లో ఉంచిన సెట్టింగ్‌లు — నకిలీ కాల్ వివరాలు, "ఇంటర్నెట్ లేనప్పుడు SMS" నంబర్లు — యాప్‌ను అన్‌ఇన్‌స్టాల్ చేసినప్పుడు పోతాయి',
...
'ಬ್ಯಾಟರಿ ಮಟ್ಟ, ಚಾರ್ಜಿಂಗ್ ಸ್ಥಿತಿ ಮತ್ತು ಚಲಿಸುವಾಗ ವೇಗ — ನಿಮ್ಮ ಸ್ಥಳದ ಜೊತೆಗೆ ಕುಟುಂಬಕ್ಕೆ ತೋರಿಸಲಾಗುತ್ತದೆ',
          ...
          "ಇನ್ನೊಬ್ಬ ಸದಸ್ಯರಿಗಾಗಿ ನೀವು ಇಡುವ ಖಾಸಗಿ ಅಡ್ಡಹೆಸರು — ನಿಮಗೆ ಮಾತ್ರ ಕಾಣುತ್ತದೆ, ಅವರಿಗೆ ಅಥವಾ ಇನ್ನಾರಿಗೂ ಅಲ್ಲ — ನಿಮ್ಮ ಫೋನಿನಲ್ಲಿ ಅಲ್ಲ, ನಮ್ಮ ಸರ್ವರ್‌ಗಳಲ್ಲಿ ಸಂಗ್ರಹಿಸಲಾಗುತ್ತದೆ",
          "ನೀವು ಒಂದು ಸಂದೇಶವನ್ನು ಓದಿದ್ದೀರಿ ಎಂಬ ಸಂಗತಿ, ಮತ್ತು ಯಾವಾಗ — ಇತರರಿಗೆ ಟಿಕ್ ಅಥವಾ 'ಸೀನ್' ಸಮಯವಾಗಿ ಕಾಣುತ್ತದೆ",
          "ನೀವು ಒಂದು ಸಂದೇಶಕ್ಕೆ ಸೇರಿಸುವ ಯಾವುದೇ ಎಮೋಜಿ ರಿಯಾಕ್ಷನ್",
...
'ಚಲನೆ ಸಂವೇದಕದ ಓದುವಿಕೆಗಳು, "ಅಲುಗಾಡಿಸಿದರೆ SOS" ಆನ್ ಇರುವಾಗ ಮಾತ್ರ — ಅವು ನಿಮ್ಮ ಫೋನಿನಲ್ಲೇ ಪರಿಶೀಲಿಸಲ್ಪಡುತ್ತವೆ, ಎಲ್ಲಿಗೂ ಕಳುಹಿಸಲ್ಪಡುವುದಿಲ್ಲ',
      ...
      use: {
        ...
        items: [
          ...
          "ಯಾರಿಗಾದರೂ ನೀವು ಇಡುವ ಅಡ್ಡಹೆಸರು ನಿಮಗೆ ಮಾತ್ರ ಖಾಸಗಿ; ಅದು ಯಾರ ಬಗ್ಗೆಯೋ ಅವರಿಗೂ ಅದು ಕಾಣುವುದಿಲ್ಲ",
          "ಓದಿದ ರಶೀದಿ ಅಥವಾ ಎಮೋಜಿ ರಿಯಾಕ್ಷನ್ ಆ ಸಂದೇಶವನ್ನು ಈಗಾಗಲೇ ಕಾಣಬಹುದಾದವರಿಗೆ ಮಾತ್ರ ಕಾಣುತ್ತದೆ",
      ...
      onphone: {
        ...
        items: [
          ...
          'ನಿಮ್ಮ ಭಾಷೆಯ ಆಯ್ಕೆ ನಿಮಗಾಗಿ ಮಾತ್ರ ಫೋನಿನಲ್ಲಿ ಉಳಿಯುತ್ತದೆ',
      ...
      protect: {
        ...
        items: [
          ...
          "ಒಂದು ಯಾದೃಚ್ಛಿಕ, ಇನ್‌ಸ್ಟಾಲ್-ಆಧಾರಿತ ಡಿವೈಸ್ ಐಡಿ (ಎಂದಿಗೂ ಹಾರ್ಡ್‌ವೇರ್ ಐಡೆಂಟಿಫೈಯರ್ ಅಲ್ಲ) ಮತ್ತು \"Android app\" ನಂತಹ ಸಾಮಾನ್ಯ ಲೇಬಲ್ ನಿಮ್ಮ ಖಾತೆಯನ್ನು ಒಂದು ಸಮಯದಲ್ಲಿ ಒಂದೇ ಡಿವೈಸ್‌ನಲ್ಲಿ ಸೈನ್ ಇನ್ ಆಗಿ ಇರಿಸಲು ಬಳಸಲಾಗುತ್ತದೆ; ಬೇರೆಡೆ ಸೈನ್ ಇನ್ ಮಾಡಿದರೆ ಹಳೆಯ ಡಿವೈಸ್ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಸೈನ್ ಔಟ್ ಆಗುತ್ತದೆ",
        ],
      },
      retention: {
        ...
        items: [
          ...
          'ಒಂದು ಸಂದೇಶಕ್ಕೆ ಜೋಡಿಸಿದ ಫೋಟೋ, ವೀಡಿಯೊ, ಧ್ವನಿ ಟಿಪ್ಪಣಿ, ಡಾಕ್ಯುಮೆಂಟ್ ಅಥವಾ ಎಮೋಜಿ ರಿಯಾಕ್ಷನ್ ಆ 90-ದಿನದ ಅಳಿಸುವಿಕೆ ನಡೆದಾಗ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ತೆಗೆದುಹಾಕಲ್ಪಡುವುದಿಲ್ಲ',
          "ಓದಿದ ರಶೀದಿ ಆ ಸಂದೇಶದೊಂದಿಗೆ ಸೇರಿ ತೆಗೆದುಹಾಕಲ್ಪಡುತ್ತದೆ",
          "ನೀವು ಯಾರಿಗಾದರೂ ಇಟ್ಟ ಅಡ್ಡಹೆಸರು, ನಿಮ್ಮಲ್ಲಿ ಯಾರಾದರೂ ಆ ಕುಟುಂಬ ಗುಂಪನ್ನು ಬಿಟ್ಟಾಗ ಅಥವಾ ನೀವು ಖಾತೆ ಅಳಿಸಿದಾಗ ತೆಗೆದುಹಾಕಲ್ಪಡುತ್ತದೆ",
...
'ನಿಮ್ಮ ಫೋನಿನಲ್ಲಿ ಉಳಿಯುವ ಸೆಟ್ಟಿಂಗ್‌ಗಳು — ನಕಲಿ ಕರೆ ವಿವರಗಳು, "ಇಂಟರ್ನೆಟ್ ಇಲ್ಲದಾಗ SMS" ಸಂಖ್ಯೆಗಳು — ಆ್ಯಪ್ ಅನ್‌ಇನ್‌ಸ್ಟಾಲ್ ಮಾಡಿದಾಗ ಹೋಗುತ್ತವೆ',
...
'ബാറ്ററി നില, ചാർജിംഗ് അവസ്ഥ, നീങ്ങുമ്പോഴുള്ള വേഗത — നിങ്ങളുടെ ലൊക്കേഷനോടൊപ്പം കുടുംബത്തിന് കാണാം',
          ...
          "മറ്റൊരു അംഗത്തിന് നിങ്ങൾ നൽകുന്ന സ്വകാര്യ വിളിപ്പേര് — നിങ്ങൾക്ക് മാത്രം കാണാം, അവർക്കോ മറ്റാർക്കോ അല്ല — നിങ്ങളുടെ ഫോണിലല്ല, ഞങ്ങളുടെ സെർവറുകളിൽ സൂക്ഷിക്കുന്നു",
          "നിങ്ങൾ ഒരു സന്ദേശം വായിച്ചു എന്ന വിവരവും എപ്പോൾ വായിച്ചു എന്നതും — മറ്റുള്ളവർക്ക് ഒരു ടിക്ക് അല്ലെങ്കിൽ 'സീൻ' സമയമായി കാണിക്കും",
          "നിങ്ങൾ ഒരു സന്ദേശത്തിന് ചേർക്കുന്ന ഏതെങ്കിലും ഇമോജി റിയാക്ഷൻ",
...
'മോഷൻ സെൻസർ റീഡിംഗുകൾ, "കുലുക്കിയാൽ SOS" ഓണായിരിക്കുമ്പോൾ മാത്രം — അവ നിങ്ങളുടെ ഫോണിൽത്തന്നെ പരിശോധിക്കപ്പെടുന്നു, എങ്ങോട്ടും അയക്കുന്നില്ല',
      ...
      use: {
        ...
        items: [
          ...
          "ആരെയെങ്കിലും കുറിച്ച് നിങ്ങൾ വെക്കുന്ന വിളിപ്പേര് നിങ്ങൾക്ക് മാത്രം സ്വകാര്യമാണ്; അത് ആരെക്കുറിച്ചാണോ അവർക്കു പോലും കാണാനാകില്ല",
          "ഒരു റീഡ് റിസീറ്റോ ഇമോജി റിയാക്ഷനോ ആ സന്ദേശം ഇതിനകം കാണാൻ കഴിയുന്നവർക്ക് മാത്രമേ കാണാനാകൂ",
      ...
      onphone: {
        ...
        items: [
          ...
          'നിങ്ങളുടെ ഭാഷാ തിരഞ്ഞെടുപ്പ് നിങ്ങൾക്കായി മാത്രം ഫോണിൽ സൂക്ഷിക്കുന്നു',
      ...
      protect: {
        ...
        items: [
          ...
          "ഒരു റാൻഡം, ഇൻസ്റ്റാൾ-അടിസ്ഥാനത്തിലുള്ള ഡിവൈസ് ഐഡിയും (ഒരിക്കലും ഹാർഡ്‌വേർ ഐഡന്റിഫയർ അല്ല) \"Android app\" പോലുള്ള ഒരു പൊതു ലേബലും നിങ്ങളുടെ അക്കൗണ്ട് ഒരു സമയത്ത് ഒരു ഡിവൈസിൽ മാത്രം സൈൻ ഇൻ ആയി നിലനിർത്താൻ ഉപയോഗിക്കുന്നു; മറ്റെവിടെയെങ്കിലും സൈൻ ഇൻ ചെയ്താൽ പഴയ ഡിവൈസ് സ്വയമേവ സൈൻ ഔട്ട് ആകും",
        ],
      },
      retention: {
        ...
        items: [
          ...
          'ഒരു സന്ദേശത്തോടൊപ്പം ചേർത്ത ഫോട്ടോ, വീഡിയോ, വോയ്‌സ് നോട്ട്, ഡോക്യുമെന്റ് അല്ലെങ്കിൽ ഇമോജി റിയാക്ഷൻ ആ 90-ദിന നീക്കം നടക്കുമ്പോൾ സ്വയമേവ നീക്കം ചെയ്യപ്പെടില്ല',
          "ഒരു റീഡ് റിസീറ്റ് ആ സന്ദേശത്തോടൊപ്പം തന്നെ നീക്കം ചെയ്യപ്പെടും",
          "നിങ്ങൾ ആർക്കെങ്കിലും വെച്ച വിളിപ്പേര്, നിങ്ങളിൽ ആരെങ്കിലും ആ കുടുംബ ഗ്രൂപ്പ് വിടുമ്പോൾ, അല്ലെങ്കിൽ നിങ്ങൾ അക്കൗണ്ട് ഇല്ലാതാക്കുമ്പോൾ നീക്കം ചെയ്യപ്പെടും",
...
'ഫോണിൽ സൂക്ഷിക്കുന്ന ക്രമീകരണങ്ങൾ — വ്യാജ കോൾ വിവരങ്ങൾ, "ഇന്റർനെറ്റ് ഇല്ലാത്തപ്പോൾ SMS" നമ്പറുകൾ — ആപ്പ് അൺഇൻസ്റ്റാൾ ചെയ്യുമ്പോൾ പോകും',
