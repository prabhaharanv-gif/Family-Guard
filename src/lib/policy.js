 ...
 *
 * ── 26 September 2026: two providers that were missing ────────────────────
 * Twilio delivers the one-time code by SMS (registration, password reset) so it
 * holds the member's mobile number; Google Maps (Android) and OpenStreetMap
 * (web) receive tile requests straight from the phone. Neither was listed under
    ...
    sections: {
      ...
      providers: {
        ...
        items: [
          ...
          'Twilio — sends the one-time verification code by SMS to your mobile number when you register or reset your password',
          'Google Maps (Android app) and OpenStreetMap (web) — draw the map. Your phone asks them for map tiles directly, so they can see your phone’s address and the area you are viewing, but never your family’s positions or names',
...
'இயக்க உணரி அளவீடுகள், "குலுக்கினால் SOS" இயக்கத்தில் இருக்கும்போது மட்டும் — அவை உங்கள் கைபேசியிலேயே ஆராயப்படுகின்றன, எங்கும் அனுப்பப்படுவதில்லை',
      ...
      providers: {
        ...
        items: [
          ...
          'Twilio — நீங்கள் பதிவு செய்யும்போது அல்லது கடவுச்சொல்லை மீட்டமைக்கும்போது உங்கள் மொபைல் எண்ணுக்கு SMS மூலம் ஒருமுறை சரிபார்ப்பு குறியீட்டை அனுப்புகிறது',
          'Google Maps (Android செயலி) மற்றும் OpenStreetMap (இணையம்) — வரைபடத்தை வரைகின்றன. உங்கள் போன் நேரடியாக வரைபடத் துண்டுகளைக் கேட்பதால், அவை உங்கள் போனின் முகவரியையும் நீங்கள் பார்க்கும் பகுதியையும் காணலாம்; உங்கள் குடும்பத்தின் இடங்களையோ பெயர்களையோ ஒருபோதும் காணாது',
...
'मोशन सेंसर की रीडिंग, केवल तब जब "हिलाकर SOS" चालू हो — इन्हें आपके फ़ोन पर ही परखा जाता है, कहीं भेजा नहीं जाता',
      ...
      providers: {
        ...
        items: [
          ...
          'Twilio — जब आप रजिस्टर करते हैं या पासवर्ड रीसेट करते हैं तो आपके मोबाइल नंबर पर SMS से एक बार का सत्यापन कोड भेजता है',
          'Google Maps (Android ऐप) और OpenStreetMap (वेब) — नक्शा बनाते हैं। आपका फ़ोन सीधे उनसे मैप टाइल माँगता है, इसलिए वे आपके फ़ोन का पता और आप जो इलाका देख रहे हैं वह देख सकते हैं, पर आपके परिवार की लोकेशन या नाम कभी नहीं',
...
'మోషన్ సెన్సార్ రీడింగ్‌లు, "ఊపితే SOS" ఆన్‌లో ఉన్నప్పుడు మాత్రమే — అవి మీ ఫోన్‌లోనే పరిశీలించబడతాయి, ఎక్కడికీ పంపబడవు',
      ...
      providers: {
        ...
        items: [
          ...
          'Twilio — మీరు నమోదు చేసుకున్నప్పుడు లేదా పాస్‌వర్డ్ రీసెట్ చేసినప్పుడు మీ మొబైల్ నంబర్‌కు SMS ద్వారా ఒక్కసారి వాడే ధృవీకరణ కోడ్‌ను పంపుతుంది',
          'Google Maps (Android యాప్) మరియు OpenStreetMap (వెబ్) — మ్యాప్‌ను గీస్తాయి. మీ ఫోన్ నేరుగా వాటి నుండి మ్యాప్ టైల్స్ అడుగుతుంది, కాబట్టి అవి మీ ఫోన్ చిరునామాను, మీరు చూస్తున్న ప్రాంతాన్ని చూడగలవు, కానీ మీ కుటుంబ సభ్యుల స్థానాలను లేదా పేర్లను ఎప్పుడూ చూడవు',
...
'ಚಲನೆ ಸಂವೇದಕದ ಓದುವಿಕೆಗಳು, "ಅಲುಗಾಡಿಸಿದರೆ SOS" ಆನ್ ಇರುವಾಗ ಮಾತ್ರ — ಅವು ನಿಮ್ಮ ಫೋನಿನಲ್ಲೇ ಪರಿಶೀಲಿಸಲ್ಪಡುತ್ತವೆ, ಎಲ್ಲಿಗೂ ಕಳುಹಿಸಲ್ಪಡುವುದಿಲ್ಲ',
      ...
      providers: {
        ...
        items: [
          ...
          'Twilio — ನೀವು ನೋಂದಾಯಿಸಿದಾಗ ಅಥವಾ ಪಾಸ್‌ವರ್ಡ್ ಮರುಹೊಂದಿಸಿದಾಗ ನಿಮ್ಮ ಮೊಬೈಲ್ ಸಂಖ್ಯೆಗೆ SMS ಮೂಲಕ ಒಂದು ಬಾರಿಯ ಪರಿಶೀಲನಾ ಕೋಡ್ ಕಳುಹಿಸುತ್ತದೆ',
          'Google Maps (Android ಆ್ಯಪ್) ಮತ್ತು OpenStreetMap (ವೆಬ್) — ನಕ್ಷೆಯನ್ನು ಬರೆಯುತ್ತವೆ. ನಿಮ್ಮ ಫೋನ್ ನೇರವಾಗಿ ಅವುಗಳಿಂದ ನಕ್ಷೆ ಟೈಲ್‌ಗಳನ್ನು ಕೇಳುತ್ತದೆ, ಆದ್ದರಿಂದ ಅವು ನಿಮ್ಮ ಫೋನ್‌ನ ವಿಳಾಸ ಮತ್ತು ನೀವು ನೋಡುತ್ತಿರುವ ಪ್ರದೇಶವನ್ನು ನೋಡಬಹುದು, ಆದರೆ ನಿಮ್ಮ ಕುಟುಂಬದ ಸ್ಥಳಗಳನ್ನು ಅಥವಾ ಹೆಸರುಗಳನ್ನು ಎಂದಿಗೂ ನೋಡುವುದಿಲ್ಲ',
...
'മോഷൻ സെൻസർ റീഡിംഗുകൾ, "കുലുക്കിയാൽ SOS" ഓണായിരിക്കുമ്പോൾ മാത്രം — അവ നിങ്ങളുടെ ഫോണിൽത്തന്നെ പരിശോധിക്കപ്പെടുന്നു, എങ്ങോട്ടും അയക്കുന്നില്ല',
      ...
      providers: {
        ...
        items: [
          ...
          'Twilio — നിങ്ങൾ രജിസ്റ്റർ ചെയ്യുമ്പോഴോ പാസ്‌വേഡ് റീസെറ്റ് ചെയ്യുമ്പോഴോ നിങ്ങളുടെ മൊബൈൽ നമ്പറിലേക്ക് SMS വഴി ഒറ്റത്തവണ സ്ഥിരീകരണ കോഡ് അയയ്ക്കുന്നു',
          'Google Maps (Android ആപ്പ്) ഉം OpenStreetMap (വെബ്) ഉം — മാപ്പ് വരയ്ക്കുന്നു. നിങ്ങളുടെ ഫോൺ നേരിട്ട് അവയിൽ നിന്ന് മാപ്പ് ടൈലുകൾ ചോദിക്കുന്നതിനാൽ, അവയ്ക്ക് നിങ്ങളുടെ ഫോണിന്റെ വിലാസവും നിങ്ങൾ കാണുന്ന പ്രദേശവും കാണാം, പക്ഷേ നിങ്ങളുടെ കുടുംബത്തിന്റെ ലൊക്കേഷനുകളോ പേരുകളോ ഒരിക്കലും കാണില്ല',
